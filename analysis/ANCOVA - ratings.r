...
nhst <- ifelse(ancova_p < 0.05, 
               "A main effect for condition was found: after controlling for self-reported racism, mean ratings were significantly different between ",
               "No main effect for condition was found: after controlling for self-reported racism, no significant differences were found between ")
...
# ancova
preamble <- "An ANCOVA was conducted with mean self-reported evaluations of the black faces as the DV, IAT condition (Race IAT vs. Flowers-Insects IAT) as the IV, and self-reported racism (M-MRS scores) entered as a covariate. "
...
## write to disk
sink("analysis/ANCOVA - ratings.txt")
