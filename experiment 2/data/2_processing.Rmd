...
AMP_summary_stats_df <- cleaned_df %>%
  ...
  dplyr::mutate(AMP_exclude_based_on_fast_trials_old = ifelse(AMP_percent_fast_trials < 0.1, FALSE, TRUE)) %>%
  dplyr::select(participant,
                AMP_mean_RT,
                AMP_perc_acc,
                AMP_exclude_based_on_fast_trials_old)
...
## The variable is still included in the data but not used.
