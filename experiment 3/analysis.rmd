...
model_sr_1 <- lmer(rating ~ IAT_condition + modern_racism_scale_total + (1 | unique_id),
                   contrasts = list(IAT_condition = "contr.sum"),  
                   data = ratings_data_exp1)
model_sr_2 <- lmer(rating ~ IAT_condition + modern_racism_scale_total + (1 | unique_id),
                   contrasts = list(IAT_condition = "contr.sum"),  
                   data = ratings_data_exp2)
model_sr_3 <- lmer(rating ~ IAT_condition + modern_racism_scale_total + (1 | unique_id),
                   contrasts = list(IAT_condition = "contr.sum"),  
...
sr_n <- rbind(sr_1_n, sr_2_n, sr_3_n) %>%
...
# combine
model_predicted_effects <- rbind(model_sr_1_predicted_effects, 
  ...
  mutate(percent_n = ifelse(is.na(percent_n), 5, percent_n*5)) %>%
