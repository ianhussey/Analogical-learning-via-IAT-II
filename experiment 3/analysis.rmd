...
# Hypothesis test 2: differences in accuracy
...
# Hypothesis test 3: differences in sensitivity (d')

H3 refers to the sensitivity analysis: main effect for IAT condition.
...
# Hypothesis test 4: differences in response bias (c)

H4 refers to the response bias analysis: main effect for IAT condition.
...
# Hypothesis test 5: Differences in self-reported ratings between contrast pair conditions

H5: Participants who complete a race IAT will demonstrate more negative self-reported evaluations of the outgroup (black people) on the ratings than participants who completed a control (flowers-insects) IAT.  
